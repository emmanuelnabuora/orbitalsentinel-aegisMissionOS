...
ROLE_PERMISSIONS: dict[Role, frozenset[Permission]] = {
    ...
    Role.ANALYST: frozenset(
        ...
        | {
            Permission.ALERTS_TRIAGE,
            Permission.THREATINTEL_READ,
            Permission.THREATINTEL_MANAGE,
            Permission.SENTINEL_USE,
            Permission.QUANTUM_READ,
        }
    ),
...
PERMISSION_GROUPS: dict[str, frozenset[Permission]] = {
    ...
    "analysis-tools": frozenset(
        {Permission.SENTINEL_USE, Permission.TWIN_SIMULATE, Permission.QUANTUM_READ}
    ),
    "reporting": frozenset({Permission.REPORTS_READ, Permission.REPORTS_GENERATE}),
    "governance": frozenset({Permission.AUDIT_READ}),
    "org-administration": frozenset(
        {Permission.USERS_MANAGE, Permission.WORKSPACE_MANAGE, Permission.KEYS_MANAGE}
    ),
}
