...
# One NAT per AZ (default): an AZ losing its NAT — or the AZ hosting a shared
# NAT going down — must not take out egress for healthy tasks in the other AZ.
...
# Per-AZ private route tables; each routes to its own AZ's NAT.
